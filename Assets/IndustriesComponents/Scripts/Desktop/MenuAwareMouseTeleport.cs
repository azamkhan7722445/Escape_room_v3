...
namespace Fusion.Samples.IndustriesComponents.Desktop
{
    /***
     * 
     * MenuAwareMouseTeleport is used for desktop rig
     * It manages the use of the mouse while a UI is displayed. Indeed :
     *  - we don't allow teleport or beam-based mouse click when a menu is opened
     *  - and we don't want to teleport them unexpectidly when they release a close button
     * 
     ***/
    public class MenuAwareMouseTeleport : MouseTeleport
    {
        ...
        protected override void Awake()
        {
            ...
            if(menuManager == null)
            {
                Debug.LogWarning("MenuManager not set on MenuAwareMouseTeleport");
        ...
        protected override void Update()
        {
            ...
            // hide the ray when the menu is open
