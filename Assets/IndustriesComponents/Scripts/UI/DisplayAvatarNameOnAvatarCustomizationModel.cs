...
/***
 * 
 * DisplayAvatarNameOnAvatarCustomizationModel loads the username from the user's preferences and displays it on the avatar model.
 * Thanks to the listener on the keyboard buffer, the username is updated when the buffer changes.
 * 
 ***/
