...
namespace Fusion.Addons.Avatar.SimpleAvatar
{
    [System.Serializable]
    ...
    public class SimpleAvatar : MonoBehaviour, IAvatar
    {
        ...
        **/
        ...
        [SerializeField]
        private AvatarStatus _avatarStatus = AvatarStatus.RepresentationAvailable;
        ...
        public string AvatarURL => config.URL;

        AvatarDescription _avatarDescription;
        ...
        public void ChangeAvatar(string avatarURL)
        {
            ...
            if (SimpleAvatarConfig.IsValidURL(avatarURL))
            {
                ...
                _avatarDescription.skinMaterial = bodyRenderer.sharedMaterial;
                _avatarDescription.clothMaterial = clothRenderer.sharedMaterial;
                _avatarDescription.hairMaterial = hairRenderer.sharedMaterial;
                _avatarDescription.hairStyle = config.hairMesh;
                _avatarDescription.colorMode = AvatarDescription.ColorMode.Material;
                _avatarDescription.hairMode = AvatarDescription.HairMode.HairStyle;
        ...
        // LoadRandomAvatar generates a random avatar, update the current avatar with the new one and return the corresponding URL
        ...
        public SimpleAvatarConfig RandomAvatarConfig()
        {
            var randomConfig = new SimpleAvatarConfig();
            randomConfig.skinMat = Random.Range(0, skinMaterials.Count);
            randomConfig.clothMat = Random.Range(0, clothMaterials.Count);
            randomConfig.clothMesh = Random.Range(0, clothMeshes.Count);
            randomConfig.hairMesh = Random.Range(0, hairMeshes.Count);
            randomConfig.hairMat = Random.Range(0, hairMaterials.Count);
            return randomConfig;
        }
